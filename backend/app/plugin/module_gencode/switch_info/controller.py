...
SwitchInfoRouter = APIRouter(prefix='/switch_info', tags=["交换机信息模块"]) 

@SwitchInfoRouter.get("/detail/{id}", summary="获取交换机信息详情", description="获取交换机信息详情")
async def get_switch_info_detail_controller(
    ...
    log.info(f"获取交换机信息详情成功 {id}")
    return SuccessResponse(data=result_dict, msg="获取交换机信息详情成功")

@SwitchInfoRouter.get("/list", summary="查询交换机信息列表", description="查询交换机信息列表")
async def get_switch_info_list_controller(
    ...
    log.info("查询交换机信息列表成功")
    return SuccessResponse(data=result_dict, msg="查询交换机信息列表成功")

@SwitchInfoRouter.post("/create", summary="创建交换机信息", description="创建交换机信息")
async def create_switch_info_controller(
    ...
    log.info("创建交换机信息成功")
    return SuccessResponse(data=result_dict, msg="创建交换机信息成功")

@SwitchInfoRouter.put("/update/{id}", summary="修改交换机信息", description="修改交换机信息")
async def update_switch_info_controller(
    ...
    log.info("修改交换机信息成功")
    return SuccessResponse(data=result_dict, msg="修改交换机信息成功")

@SwitchInfoRouter.delete("/delete", summary="删除交换机信息", description="删除交换机信息")
async def delete_switch_info_controller(
    ...
    log.info(f"删除交换机信息成功: {ids}")
    return SuccessResponse(msg="删除交换机信息成功")

@SwitchInfoRouter.patch("/available/setting", summary="批量修改交换机信息状态", description="批量修改交换机信息状态")
async def batch_set_available_switch_info_controller(
    ...
    log.info(f"批量修改交换机信息状态成功: {data.ids}")
    return SuccessResponse(msg="批量修改交换机信息状态成功")

@SwitchInfoRouter.post('/export', summary="导出交换机信息", description="导出交换机信息")
...
@SwitchInfoRouter.post('/import', summary="导入交换机信息", description="导入交换机信息")
async def import_switch_info_list_controller(
    ...
    log.info("导入交换机信息成功")
    return SuccessResponse(data=batch_import_result, msg="导入交换机信息成功")

@SwitchInfoRouter.post('/download/template', summary="获取交换机信息导入模板", description="获取交换机信息导入模板", dependencies=[Depends(AuthPermission(["module_gencode:switch_info:download"]))])
